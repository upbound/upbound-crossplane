...
- [ ] Cut [upbound/crossplane][upbound-xp-fork] `vX.Y.Z-up.1` release from the `release-X.Y` branch by:
  ...
  - [ ] Create a [new release][new-release-u-xp] for `vX.Y.Z-up.1` with autogenerated notes and any additional note needed.
...
[new-release-u-xp]: https://github.com/upbound/crossplane/releases/new
